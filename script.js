    ...
    meals.then(data=>{
        if (data.meals) {
            data.meals.forEach((element) => {
                ...
                if (isFav) {
                    html += `
                <div id="card" class="card mb-3" style="width: 16rem;">
            ...
            <div class="page-wrap d-flex flex-row align-items-center">
                <div class="container">
                    <div class="row justify-content-center" style="border: 1px dashed #fff; padding:20px;">
    ...
    if (arr.length==0) {
            ...
            <div class="page-wrap d-flex flex-row align-items-center">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-6 d-block">404</span>
                            <div class="mb-4">
        ...
        for (let index = 0; index < arr.length; index++) {
            await fetchMealsFromApi(url,arr[index]).then(data=>{
                html += `
                <div id="card" class="card mb-3" style="width: 15rem; height:fit-content; text-align:center;">
                    <img src="${data.meals[0].strMealThumb}" class="card-img-top" alt="..." style="width: 70%; margin:auto;">
                    <div class="card-body">
